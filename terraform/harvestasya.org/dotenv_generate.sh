...
export TF_VAR_google_oauth_client_id="$(op read "op://x6jqey4sr626ozkw3x7dhlns4e/h4j4jqjbbfgivrygocq2adndrm/TF_VAR_google_oauth_client_id")"
export TF_VAR_google_oauth_client_secret="$(op read "op://x6jqey4sr626ozkw3x7dhlns4e/h4j4jqjbbfgivrygocq2adndrm/TF_VAR_google_oauth_client_secret")"
